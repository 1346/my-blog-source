---
title: vue-cli里文件的一些说明
date: 2018-01-22 10:31:06
categories: vue
---
## 相关目录
...
'use strict'
// npm和node版本检查，请看check-versions配置文件详解
require('./check-versions')()

// 设置环境变量为production(process是node中的global全局对象的属性，process是node中的全局变量，env设置环境变量)
